...
/**
 * Generic HMAC-SHA256 verifier: the signature is hex(HMAC-SHA256(secret, rawBody)),
 * read from a configurable header. Use this for providers that sign the raw body with
 * a shared secret and expose a plain hex signature.
 */
